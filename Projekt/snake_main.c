...
void eat_apple(){
  ...
  int apple_new_x = get_random_value() % (SCREEN_WIDTH); //scaled_rand(SCREEN_WIDTH-BLOCK_SIZE);
  int apple_new_y = get_random_value() % (SCREEN_HEIGHT);//scaled_rand(SCREEN_HEIGHT-BLOCK_SIZE);
