...
void OledGetBmp(int dxco, int dyco, BYTE * pbBits)
{
	int		xcoLeft;
	int		xcoRight;
	int		ycoTop;
	...
	int		bnAlign;
	BYTE	mskEnd;
	BYTE	__attribute__((unused)) bTmp;
...
void OledPutBmp(int dxco, int dyco, BYTE * pbBits)
{
	int		xcoLeft;
	int		xcoRight;
	int		ycoTop;
...
{
	BYTE *	pbFont;
	BYTE *	__attribute__((unused)) pbBmp;
